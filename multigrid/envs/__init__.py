...
CONFIGURATIONS = {
    ...
    "MultiGrid-CompetativeRedBlueDoor-v3-DTDE-Red-Single": (  # Task 1, HW 1:  adjust pickup penalty
        CompetativeRedBlueDoorEnvV3,
        {
            "size": 8,
            ...
            "reward_schemes": {
                "red_0": {
                    ...
                    "invalid_pickup_dense_penalty": 0.05, # HW1 FIXME 1 - This value maybe too high for dense penalty 
                },
            },
        },
    ),
